...
public class LotManagementController extends HttpServlet {
    ...
    private void router(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (route) {
            case "list":
                ...
                break;
            case "listBidder":
                this.listLotFromBidder(req, resp);
                break;
            case "add":
    ...
    private void listLotFromBidder(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        HttpSession session = req.getSession();
        List<Lot> lots;
        ...
        try {
            ...
            req.setAttribute("lots", lots);
            req.getRequestDispatcher("jsp/BIDDER_LOTS_BOARD.jsp").forward(req, resp);
        } catch (SQLException e) {
    ...
    private void addLot(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (user instanceof Auctioneer) {
            ...
            throw new IllegalArgumentException("Only auctioneers can add lots.");
        }
    }
