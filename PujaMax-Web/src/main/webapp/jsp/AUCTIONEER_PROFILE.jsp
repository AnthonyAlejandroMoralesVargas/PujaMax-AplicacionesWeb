					...
					<div class="modal-body">
						...
						<div class="row g-4">
							<div class="col-md-6">
								...
								<input id="NameAddAddress" type="text"
									class="form-control rounded-3" name="txtName"
									placeholder="Enter name" required>
							</div>
							<div class="col-md-6">
								<label for="CompanyAddAddress" class="form-label fw-semibold">Company
									(Optional)</label> <input id="CompanyAddAddress" type="text"
						...
						<div class="row g-4 mt-2">
							<div class="col-md-6">
								...
								<input id="ProvinceAddAddress" type="text"
							...
							<div class="col-md-6">
								...
								<input id="CityAddAddress" type="text"
						...
						<div class="row g-4 mt-2">
							<div class="col-md-6">
								<label for="MSAddAddress" class="form-label fw-semibold">Main
									Street</label> <input id="MSAddAddress" type="text"
									class="form-control rounded-3" name="txtMainStreet"
									placeholder="Enter main street" required>
							</div>
							<div class="col-md-6">
								<label for="SSAddAddress" class="form-label fw-semibold">Secondary
									Street</label> <input id="SSAddAddress" type="text"
						...
						<div class="row g-4 mt-2">
							<div class="col-md-6">
								...
								<input id="PostCodeAddAddress" type="text"
									class="form-control rounded-3" name="txtPostcode"
									placeholder="Enter postcode" required>
							</div>
							<div class="col-md-6">
								<label for="HouseAddAddress" class="form-label fw-semibold">House/Apartment
									No.</label> <input id="HouseAddAddress" type="text"
									class="form-control rounded-3" name="txtHouseNumber"
				...
				<form action="AddressManagementController?route=saveExisting"
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								<label for="NameEditAddress" class="form-label fw-bold">Name</label>
								<input id="NameEditAddress" type="text" class="form-control"
									name="txtName" value="${address.name}" placeholder="Enter name"
									required>
							</div>
							<div class="col-md-6 mb-3">
								<label for="CompanyEditAddress" class="form-label fw-bold">Company
									(Optional)</label> <input id="CompanyEditAddress" type="text"
									class="form-control" name="txtCompany"
									value="${address.company}" placeholder="Enter company">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								...
								<input id="ProvinceEditAddress" type="text" class="form-control"
									name="txtProvince" value="${address.province}"
									placeholder="Enter province" required>
							</div>
							<div class="col-md-6 mb-3">
								<label for="CityEditAddress" class="form-label fw-bold">City</label>
								<input id="CityEditAddress" type="text" class="form-control"
									name="txtCity" value="${address.city}" placeholder="Enter city"
									required>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="MSEditAddress" class="form-label fw-bold">Main
									Street</label> <input id="MSEditAddress" type="text"
									class="form-control" name="txtMainStreet"
									value="${address.mainStreet}" placeholder="Enter main street"
									required>
							</div>
							<div class="col-md-6 mb-3">
								<label for="SSEditAddress" class="form-label fw-bold">Secondary
									Street </label> <input id="SSEditAddress" type="text"
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								...
								<input id="PostCodeEditAddress" type="text" class="form-control"
									name="txtPostcode" value="${address.postcode}"
									placeholder="Enter postcode" required>
							</div>
							<div class="col-md-6 mb-3">
								<label for="HouseEditAddress" class="form-label fw-bold">House/Apartment
									No.</label> <input id="HouseEditAddress" type="text"
									class="form-control" name="txtHouseNumber"
