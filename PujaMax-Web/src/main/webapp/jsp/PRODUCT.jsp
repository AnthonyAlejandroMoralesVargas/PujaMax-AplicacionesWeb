...
<body>
                ...
                <div id="productCarousel" class="carousel slide mb-3" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="PlaceBidController?route=list&idProduct=${product.idProduct}" class="d-block w-100 rounded" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="PlaceBidController?route=list&idProduct=${product.idProduct}" class="d-block w-100 rounded" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="PlaceBidController?route=list&idProduct=${product.idProduct}" class="d-block w-100 rounded" alt="Image 3">
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-6 ">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-6">
                                <label class="form-label">Bids</label> <input type="text" class="form-control" value="${bidCount}" readonly>
                            </div>
                            <div class="col-6">
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                <div class="col-6 d-flex">
                                    <label class="form-label">Your offer</label> <input type="number" step="0.01" name="bidAmount" class="form-control text-danger fw-bold" placeholder="Enter your bid" required>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bidConfirmationForm" action="PlaceBidController?route=placeBid" method="post">
                        <input type="hidden" name="idProduct" value="${product.idProduct}">
                        <input type="hidden" name="bidAmount" id="hiddenBidAmount">
                        <div class="mb-3">
                            <label for="productTitle" class="form-label">Title of product</label>
    ...
    <script>
        ...
        document.querySelector('[data-bs-target="#NEW_HIGH_BID"]').addEventListener('click', function() {
            const bidAmount = document.querySelector('[name="bidAmount"]').value;
