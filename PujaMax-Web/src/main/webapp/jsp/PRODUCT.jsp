			...
			<nav class="nav-container">
				<div class="d-flex flex-column flex-md-row">
					<a href="LotManagementController?route=listBidder&idLot=${idLot}"
						...
						href="${pageContext.request.contextPath}/PlaceBidController?route=history"
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="row mb-3">
							...
							<div class="col-6">
								<label class="form-label">Current price</label> <input
									type="text" class="form-control"
									value="${bid.currentPrice != null ?
							bid.currentPrice : product.priceInitial}"
									readonly>
							</div>
						</div>
						...
						<form>
							...
							<div class="row mb-3">
								<div class="col-6 d-flex">
									<label class="form-label">Your offer</label> <input
										type="number" step="0.01" name="bidAmount"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="bidConfirmationForm"
						action="PlaceBidController?route=placeBid" method="post">
						...
						<div class="mb-3">
							<label for="bidAmount" class="form-label">Your Offer</label> <input
								type="text" id="bidAmountDisplay" class="form-control" readonly>
						</div>
					</form>
				</div>
