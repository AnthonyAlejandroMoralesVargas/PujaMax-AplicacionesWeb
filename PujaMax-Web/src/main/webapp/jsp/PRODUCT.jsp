			...
			<nav class="nav-container">
				<div class="d-flex flex-column flex-md-row">
					<a href="LotManagementController?route=list&idLot=${idLot}"
						class="nav-item me-3"><i class="fas fa-home"></i> Home</a> <a
						href="BIDDER_HISTORY.jsp" class="nav-item"><i
		...
		<section class="bidProduct row gy-4">
			...
			<div class="col-12 col-lg-6 ">
				...
				<div class="alert alert-secondary mt-1 text-center">
					<span>You did not bid this Product</span>
				</div>
			</div>
				...
				<div class="card">
					...
					<div
						...
						<span class="badge bg-success"><i class="fas fa-gavel"></i>
							ACTIVE</span> <span>LOT 1</span>
					</div>

					<!-- Bid Info -->
					<div class="card-body">
						<form action="PlaceBidController" method="post"
							enctype="multipart/form-data">
							<div class="row mb-3">
								<div class="col-6">
									<label class="form-label">Bids</label> <input type="text"
										class="form-control" value="${bidCount}" readonly>
								</div>
								<div class="col-6">
							...
							<div class="row mb-3">
								<div class="col-6 d-flex ">
									<label class="form-label">Your offer</label> <input type="text"
										class="form-control text-danger fw-bold"
										value="${yourOffer}" readonly>
								</div>

							</div>
							<button type="button" class="btn btn-primary w-100"
								data-bs-toggle="modal" data-bs-target="#NEW_HIGH_BID">Submit</button>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="modal-content">
				<div class="modal-header bg-primary text-white">
					<h5 class="modal-title" id="NEW_HIGH_BIDLabel">
						<i class="fas fa-layer-group"></i> New High Bid
					</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form id="bidForm" action="PlaceBidController" method="post"
						enctype="multipart/form-data">
						<input type="hidden" name="route" value="submit"> <input
							type="hidden" name="idProduct" value="${product.idProduct}">

						<div class="mb-3">
							<label for="productTitle" class="form-label">Title of
								product</label> <input type="text" id="productTitle" name="productTitle"
								class="form-control" value="${product.title}" readonly>
						</div>
						<div class="mb-3">
							<label for="currentPrice" class="form-label">Current
								Price</label> <input type="text" id="currentPrice" name="currentPrice"
								class="form-control"
								value="${currentPrice}" readonly>
						</div>
						<div class="mb-3">
                        <label for="yourBid" class="form-label">Your Bid</label>
                        <input type="number" id="yourBid" name="yourBid" class="form-control" placeholder="Enter your bid" required min="${currentPrice + 1}">
                    </div>
					</form>
				</div>
				<div class="modal-footer justify-content-center">
					...
					<button type="submit" class="btn btn-primary" form="bidForm">Confirm</button>
				</div>
			</div>
		</div>
	</div>
